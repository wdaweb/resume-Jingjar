...
?>
<form action="../api/edit_profile.php" method="post" enctype="multipart/form-data">
    <table style="width:100%">
        <tr>
            <td width="20%" style="vertical-align:top;text-align:right">做品資料</td>
            <td>
                <div>作品名：<input type="text" name="name" value="<?= $profile['name']; ?>"></div>
                <div>作品連結：<input type="text" name="href" value="<?= $profile['href']; ?>"></div>
        ...
        <tr>
            ...
            <td><textarea name="intro" style="width:98%;height:60px"><?= $profile['intro']; ?></textarea>
            </td>
        </tr>
    </table>
    <div class="ct">
